...
const ProViceChancellor = () => {
    ...
    const approvedNonTeachingBtn = async (id) => {
        const userObj = {
            chairman: false,
            vicechancellor: true,
            provicechancellor: false,
        }
        await updateDoc(doc(db, "nonTeachingStaff", id), userObj)
        // console.log(id)
    }   
    useEffect(() => {
        getTeachingData()
                                ...
                                return (
                                    e.provicechancellor === true ? (
                                        <tr key={i}>
                                            ...
                                            <td><Button variant='contained' onClick={() => approvedBtn(e.id)}>Approve</Button></td>
                                        </tr>
                                    ) : ""
                                )
                            }
